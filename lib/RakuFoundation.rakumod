...
use RakuFoundation::PolicyPlan2026;
...
my Nav $nav = nav
  logo => (
    span a :href<https://raku.foundation>, :target<_self>, :style("display: flex; align-items: center; gap: 0.5rem; text-decoration: none;"),
    [
      img
      ...
      p :style("margin:0"),"The Raku Foundation";
    ]
  ),
  :widgets[lightdark],
  [
